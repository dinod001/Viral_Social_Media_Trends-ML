...
class MLflowTracker:
    ...
    def setup_mlflow(self):
        ...
        experiment_name = self.config.get('experiment_name', 'socail_media_analyzer')
    ...
    def log_data_pipeline_metrics(self, dataset_info: Dict[str, Any]):
        ...
        try:
            # Log non-numeric information as tags
            if 'model' in dataset_info:
                mlflow.set_tag('model_type', dataset_info['model'])
